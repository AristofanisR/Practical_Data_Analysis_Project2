...
The final model coefficients at the optimal lambda (chosen through cross-validation) include only those variables and interactions with non-zero coefficients, which are presented in the resulting table (Table 4). This selection helps identify significant moderators of smoking abstinence while maintaining a simpler model.

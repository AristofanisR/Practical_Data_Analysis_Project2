...
Lastly, we performed best subset selection to identify the most predictive set of variables for smoking abstinence. For the first objective, we used sequential replacement (it was not possible to use every possible combination of variables - exhausted replacement - as the number of interactions could be over a million) to find the one that best explains the outcome with a balance between predictive power and model complexity.
